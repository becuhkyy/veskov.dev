...
const CONFIG = {
  ...
  experience: [
    ...
    },
    {
      ...
      desc: "Two-person team; I run the projects and implement most of the code: the lab's order and patient journal, a cash-flow book across shops, a REST service over the legacy Firebird databases, and a bot that babysits a flaky national export.",
    },
    {
      role: "Senior System Administrator",
      org:  "Nodisto IT, LLC (VPSDime · Backupsy · Winity)",
      when: "2014-2026 · remote",
      desc: "Ran the infrastructure behind three VPS brands with a team of four: 200+ hypervisors, 10,000+ virtual machines, six data centers. In-house Go orchestrator replacing SolusVM, automated monitoring acting directly in WHMCS, automated order review with fraud scoring, template builds, and a 15-minute response time, 24/7/365.",
    },
    {
      role: "Co-Founder",
      org:  "ImpactHost Ltd.",
