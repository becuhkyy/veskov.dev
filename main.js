...
const CONFIG = {
  ...
  about: [
    ...
    "The clearest example is the Bulgarian Volleyball Federation's competition platform, which I designed and shipped end to end: schedule generation, match documents, a live-scoring PWA referees use court-side, and the federation's electronic licence registry, in production since 2025.",
  ...
  experience: [
    {
      ...
      desc: "Ran the infrastructure behind several VPS brands: fleet monitoring, incident response under time pressure, abuse handling, and internal tooling that automated the recurring work away.",
    },
    {
      role: "Co-Founder",
      org:  "ImpactHost Ltd.",
    ...
    },
    {
      ...
      when: "2023-2025",
      desc: "Coordinated regional competitions. Running tournaments on paper and spreadsheets is what led directly to building the federation's software.",
    },
    {
  ...
  projects: [
    {
      name:  "bvf-platform",
      desc:  "The Bulgarian Volleyball Federation's competition system, end to end. It handles Berger schedule generation, championship and team management, and match document generation. Referees run the live-scoring PWA court-side, on a dependency-free, offline-tolerant scoring engine.",
      stack: ["typescript", "strapi 5", "react 19", "pwa", "playwright"],
      link:  "https://github.com/becuhkyy/bvf-livescore",
      demo:  "",
      note:  "live-scoring source is public; the rest is private",
    },
    {
      name:  "bvf-registry",
      desc:  "The federation's electronic licence system for clubs, players, coaches, licences, transfers, halls and season applications, feeding both the admin SPA and the public register on bvf.bg. In production since 2025.",
    ...
    {
      name:  "pushdb",
      desc:  "Database backup orchestration SaaS, born from running backup-heavy hosting infrastructure for a decade. Monorepo with a web app, a scheduler and a worker, containerised and deployed to k8s.",
      stack: ["typescript", "tanstack start", "postgres", "docker", "kubernetes"],
      link:  "",
      demo:  "",
    ...
    {
      name:  "notabene-suite",
      desc:  "Systems for the Nota Bene pharmacy chain and its medical laboratory. The core is an order and patient journal, plus a cash-flow book that spans registers, safes and transfers across shops. Underneath it, a service exposes the legacy Firebird databases over a clean REST API, and a stubborn Python bot retries a flaky national export until it gets a complete one.",
      stack: ["next.js", "nestjs", "prisma", "postgresql", "firebird", "python"],
      link:  "",
      demo:  "",
      note:  "private repos, client work",
    },
    {
      name:  "nestjs-portfolio",
      desc:  "A set of services built to production patterns rather than tutorial patterns: reservations with payments, task management, a GraphQL API, and an AI microservice, all with DI, tests and containers throughout.",
      stack: ["typescript", "nestjs", "graphql", "mongodb", "next.js"],
      link:  "https://github.com/becuhkyy?tab=repositories&q=nestjs",
      demo:  "",
      note:  "",
    },
  ],
